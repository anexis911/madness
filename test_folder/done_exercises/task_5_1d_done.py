...
my_input_1 = input("Введите имя устройства: ").lower()
exception = "Такого параметра нет"
string_1 = str(london_co.get(my_input_1).keys())[11:-2]
print("Введите имя параметра: "  + string_1)
my_input_2 = input().lower()
