...
def generate_trunk_config (trunk_conf, trunk_template):
	for tr_line in trunk_conf.items():
		print("interface " + tr_line[0])
		new_access_template = "\n".join(trunk_template)
		print(new_access_template.format(" " +str(tr_line[1])))
